...
export class DashboardComponent implements OnInit {
  ...
  firstOptions: IAngularMyDpOptions = {
    dateRange: false,
    dateFormat: 'dd.mm.yyyy'
    // other options are here...
  };
  firstModel: IMyDateModel = {isRange: false, singleDate: {jsDate: new Date()}};

  secondOptions: IAngularMyDpOptions = {
    dateRange: true,
    dateFormat: 'dd.mm.yyyy'
    // other options are here...
  };
  date: Date = new Date();
  secondModel: IMyDateModel = {isRange: true, singleDate: null, dateRange: {
    beginDate: {year: this.date.getFullYear(), month: this.date.getMonth() + 1, day: this.date.getDate() - 7},
    endDate: {year: this.date.getFullYear(), month: this.date.getMonth() + 1, day: this.date.getDate()}
  }};

  thirdOptions: IAngularMyDpOptions = {
    
  };
  thirdModel: IMyDateModel = null;//{isRange: false, singleDate: {jsDate: new Date()}};
  ...
  ngOnInit() {
    ...
    var data = {
      ...
      datasets: [{
        ...
        pointHoverBorderWidth: 15,
        pointRadius: 4,
        data: [34, 16, 65, 30, 126, 115, 120, 97, 53, 24, 124, 7, 99, 110, 0, 114, 68, 58, 26, 81, 7, 5, 6, 2],
      }]
    };
